<?php include("appleconnection.php");
...
<style>
	...
	width:100%;
    height:100vh ;
    background-image: url(bg-1222.jpg);
	...
	<div class="container">
		...
		<script >
			function submitform()
			{
				...
				function openlink()
			{
				var linktoopen='http://localhost/crud/appledisplay.php';
...
<?php
  if($_POST['register'])
  {
  	...
  	$query="INSERT INTO aform values('$name','$contact','$address','$pincode')";
