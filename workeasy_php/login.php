...
<body>
	<div class="center" >
		...
		<div class="form">
			<input type="text" name="username" class="textfield" placeholder="User Email">
		...
		<div class="signup">New Member ? <a href="form0.php" class="link"> Signup</a></div>
	</div>
	</form>
	<script>
		function message()
...
<?php
	...
	if(isset($_POST['login']))
	{
		...
		$query=" SELECT * FROM lform WHERE email='$username' && password='$password'";
