...
if(isset($_GET['search']))
{
    ...
    $query = "SELECT * FROM sform WHERE CONCAT(lcn, domain, salary, address,phonenum) LIKE '%$filtervalues%'";
}
else
{
    // If no search query, fetch all records
    $query = "SELECT * FROM sform";
}
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h1> <center>YOUR SELECTION</center></h1>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-7">
                        ...
                        <table>
                            <thead>
                                <tr>
                                    ...
                                    <th>Phone No of Hierer</th>
                                    <th>Salary Provided</th>
