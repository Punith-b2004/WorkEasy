<?php include("orangeconnection.php");
...
<head>
	...
	body{
			width:100%;
            height: auto;
            background-image: linear-gradient(rgba(0,0,0,0.5),#3351b5),url(bg-1222.jpg);
	...
	<div class="container">
		...
		<script >
			function submitform()
			{
				...
				function openlink()
			{
				var linktoopen='http://localhost/crud/orangedisplay.php';
...
<?php
  if($_POST['register'])
  {
  	...
  	$query="INSERT INTO oform values('$name','$contact','$address','$pincode')";
