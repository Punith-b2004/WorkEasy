	...
	<div class="container">
		...
		<script >
			function submitform()
			{
				...
				function openlink()
			{
				var linktoopen='http://localhost/crud/bandisplay.php';
...
<?php
  if($_POST['register'])
  {
  	...
  	$query="INSERT INTO banform values('$name','$contact','$address','$pincode')";
