<?php include("roseconnection.php");
	...
	<div class="container">
		...
		<script >
			function submitform()
			{
				...
				function openlink()
			{
				var linktoopen='http://localhost/crud/rdisplay.php';
...
<?php
  if($_POST['register'])
  {
  	...
  	$query="INSERT INTO rform values('$name','$contact','$address','$pincode')";
